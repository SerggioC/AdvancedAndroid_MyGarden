...
How to implement widgets. Widget extends BroadcastReceiver. widget_provider_info.xml file in xml folder defines its properties: xml layout file, on drag image resource, update interval (>= 30 minutes in milliseconds), etc.
![Widgets](/android_widgets.jpg)
